...
public class BidirectionalMap<TForwardKey, TReverseKey> : IEnumerable<KeyValuePair<TForwardKey, TReverseKey>>
{
    ...
    public BidirectionalMap(IDictionary<TForwardKey, TReverseKey> oneWayMap)
    {
